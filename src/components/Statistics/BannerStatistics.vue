    ...
    <el-row :gutter="10">
      ...
      <el-col :xs="24" :sm="8">
        <colorful-card
          ...
          gradient-end="#ce9ffc"
        >
          <div text-1.5em v-text="information.cBillIncome.toFixed(2)" />
          <template #footer>
      ...
      <el-col :xs="24" :sm="8">
        <colorful-card
          title="支出总额" icon="mdi:checkbox-multiple-marked-outline" gradient-start="#ce9ffc"
          gradient-end="#96f2ff"
        >
          <div text-1.5em v-text="information.cBillExpense.toFixed(2)" />
          <template #footer>
            <div flex="~ row items-center gap-1" text-1em>
              <span>与上月相比</span>
              <trend
